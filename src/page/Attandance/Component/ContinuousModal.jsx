      ...
      <Transition appear show={isOpen} as={Fragment}>
        ...
        >
          <div className="min-h-screen px-4 text-center">
            ...
            >
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform shadow-xl rounded-2xl ring ring-green-600 bg-green-50 text-mainBlack dark:bg-darkComponent">
                <Dialog.Title
                  as="h3"
                ...
                <div className="m-auto mt-4 w-fit">
                  <button
                    type="button"
                    className="inline-flex justify-center px-4 py-2 text-sm font-bold border-2 border-green-600 rounded-md text-green-900 bg-green-100 hover:bg-green-200"
                    onClick={closeModal}
                  >
                    Thanks!
                  </button>
...
export default ContinuousModal;
