          ...
          <div class="p-2 rounded-lg bg-mainYellow shadow-lg sm:p-3">
            <div class="flex items-center justify-between flex-wrap">
              ...
              <div class="order-3 mt-2 flex-shrink-0 w-full sm:order-2 sm:mt-0 sm:w-auto">
                <a href="#" class="flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-sm font-medium text-mainYellow bg-white hover:bg-indigo-50"> Learn more </a>
              </div>
              <div class="order-2 flex-shrink-0 sm:order-3 sm:ml-2">
                <button type="button" class="-mr-1 flex p-2 rounded-md hover:bg-mainYellow focus:outline-none focus:ring-2 focus:ring-white">
