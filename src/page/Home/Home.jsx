    ...
    <div className="home">
      ...
      <section className="posts_preview grid grid-cols-2 gap-8 justify-between text-center pt-40">
        <section className="notice_posts_preview">
          <div>공지</div>
          <div className="pt-8">
            <div>1. 공지 제목, (댓글 수), 작성자 닉네임, 시간 또는 날짜</div>
            <div>2. 공지 제목, (댓글 수), 작성자 닉네임, 시간 또는 날짜</div>
            <div>3. 공지 제목, (댓글 수), 작성자 닉네임, 시간 또는 날짜</div>
            <div>4. 공지 제목, (댓글 수), 작성자 닉네임, 시간 또는 날짜</div>
            <div>5. 공지 제목, (댓글 수), 작성자 닉네임, 시간 또는 날짜</div>
          </div>
        </section>
