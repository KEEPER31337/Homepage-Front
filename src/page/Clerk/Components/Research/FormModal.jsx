      ...
      <div className="my-auto">
        ...
        >
          <div className="flex flex-col justify-center items-center h-full">
            <div className="w-[30em] flex flex-col gap-4">
              <div className="flex items-center gap-2">
                <span className="w-[8em] p-4 font-bold">활동 여부</span>
                <select
                  ...
                  onBlur={(e) =>
                    setResponse({ ...response, state: e.target.value })
                  }
              ...
              <div className="flex items-center gap-2">
                <span className="w-[8em] p-4 font-bold">
                  휴면 사유
                  <br />
                  <span className="text-gray-400">(선택)</span>
                </span>
                <textarea
                  className="resize-none w-[22em] h-[10em] mt-1 inline-block px-3 py-2 text-base border-gray-300 focus:outline-none focus:ring-violet-400 focus:border-violet-400 sm:text-sm rounded-md dark:bg-mainBlack dark:border-darkComponent"
                  onBlur={(e) =>
